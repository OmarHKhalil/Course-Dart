...
├── bank-full.csv
├── confusion_matrix_DT(max_depth=9).png
├── confusion_matrix_KNN(K=14).png
├── confusion_matrix_RF.png
├── KNN_Error Rate vs. K Value.png
...
```text
Image: confusion_matrix_DT(max_depth=9).png
```
...
```text
Image: KNN_Error Rate vs. K Value.png
```
...
```text
Image: confusion_matrix_KNN(K=14).png
```
...
* Contributors: e-Machine-Learning-Projects
